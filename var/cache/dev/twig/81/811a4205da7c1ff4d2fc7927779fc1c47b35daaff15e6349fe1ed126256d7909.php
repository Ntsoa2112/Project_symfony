...
class __TwigTemplate_c7f3643da779e81083e3fe5ffbc050517c7ec1cebebe51b27264c64319b7604e extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <button type=\"submit\" class=\"btn btn-success\">
        ...
        if ((isset($context["editMode"]) || array_key_exists("editMode", $context) ? $context["editMode"] : (function () { throw new RuntimeError('Variable "editMode" does not exist.', 17, $this->source); })())) {
            // line 18
            echo "            Enregistrer les modification
        ";
        } else {
            // line 20
...
";
    ...
    {
        return array (  110 => 24,  106 => 22,  102 => 20,  98 => 18,  96 => 17,  90 => 14,  86 => 13,  82 => 12,  76 => 9,  71 => 6,  61 => 5,  50 => 1,  48 => 3,  35 => 1,);
    }
...
{% block body %}
    ...
    {{ form_row(formArticle.title, {'attr': {'placeholder':\"Le titre\"}}) }}
    {{ form_row(formArticle.content, {'attr': {'placeholder':\"Le contenu\"}}) }}
    {{ form_row(formArticle.image, {'attr': {'placeholder':\"Nom de l'Image\"}}) }}
...
{% endblock %}", "blog/create.html.twig", "/home/mihaingoherilanto/Documents/Etude/Mes projets/Symfony/demo/templates/blog/create.html.twig");
    }
}
